...
fun String.getBackgroundColor() = when (this) {
    ...
    "LA" -> colorResource(id = R.color.copper_crayola)
    ...
    "FE" -> colorResource(id = R.color.uranian_blue)
    "IB" -> colorResource(id = R.color.cornflower_blue)
    "AT" -> colorResource(id = R.color.persian_indigo)
    "AM" -> colorResource(id = R.color.russian_blue)
